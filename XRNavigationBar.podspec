#
#  Be sure to run `pod spec lint XRNavigationBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "LL"
  # s.authors            = { "LL" => "1670978751@qq.com" }
  ...
  s.source       = { :git => "https://github.com/pingyuanheliu/NavigationBar.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "NavigationBar/XRNavigationBar/**/*.{h,m}"
